...
Key capabilities
2.1 Production-ready for common use cases
2.2 On-device or in the cloud
2.3 Deploy custom models

Example (Face detection)
3.1 Before you begin
3.2 Input image guidelines
     3.21 Configure the face detector
     3.22 Run the face detector
     3.23 Get information about detected faces
...
youtube.com/watch?v=ejrn_JHksws
...
Face + Emotion detection - https://drive.google.com/file/d/1Lo7hGwFRmK6pW15g0egWrqWKd9cdZWDm/view?usp=sharing

https://drive.google.com/file/d/1oaGBuABMPjYL6G8NXNehK6kWJQEPwzl4/view?usp=sharing
